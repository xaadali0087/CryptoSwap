    ...
    return (
        <>
            <div className="settings">
                ...
                <h1>1% fee charged on each trade.</h1>
                <div className="disclaimer">Investments, including cryptocurrencies, inherently entail the risk of potential capital loss. It is crucial to exercise caution and only allocate funds that you can afford to lose. CryptoCoin Easy Swap operates as a decentralized exchange aggregator and does not retain or exert control over users' assets. It's important to note that transactions conducted on the blockchain are irreversible.</div>
            </div>
            <style jsx>{`
             .disclaimer {
                width: 100%;
